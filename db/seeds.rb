...
b11 = Book.create(title: "The Last Kingdom", author: "Bernard Cornwell", description: "The first installment of Bernard Cornwells bestselling series chronicling the epic saga of the making of England.", publisher: "Harper Paperbacks", weeks_on_list: 200, rank_this_week: 1)
b12 = Book.create(title: "The Eagle's Conquest", author: "Simon Scarrow", description: "Centurion Macro arrives on British soil as one of Emperor Claudius's invasion force in 43 AD.", publisher: "Headline Book Publishing", weeks_on_list: 189, rank_this_week: 3)
...
Review.create(comment: "The battles are more to-the-point than GoT.", author: "Sharon", book_id: b11.id)
Review.create(comment: "The Last Kingdom, by Bernard Cornwell, is a triumph of a novel", author: "Sean", book_id: b11.id)
Review.create(comment: "All I knew was that it was a book about Vikings.", author: "Sutty", book_id: b11.id)
Review.create(comment: "Love, all I feel is love for this book. It's like an epic love story but for a man who fought for what was rightfully his.", author: "Sweep", book_id: b11.id)

Review.create(comment: "I really, really enjoyed this second book in the Eagle series. Simon Scarrow writes very well and both his story and his characters come to life. I'm very happy I gave this series a chance and am hopng the rest of the series is just as good.", author: "Adam", book_id: b12.id)
Review.create(comment: "There wasn't much wrong with this novel other than the bits seemed to plod between the battles.", author: "Richard", book_id: b11.id)
Review.create(comment: "It surprises me just how bland and un-engaging a novel Scarrow puts out.", author: "Paul", book_id: b12.id)
